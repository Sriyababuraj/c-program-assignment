         ...
         switch(ch)
           {
             case1:
                 ...
                 scanf("%f%f",&a,&b);
                 printf("\ Area  of Triangle=%f",a*b);
                 break;
             case2:
                 printf("\n Enter the length of the parallel sides  anf height of the Trapezium:");
                 scanf("%f%f%f",&p1,&p2,&h);
             ...
             case3:
                 ...
                 break;
             case4:
                 printf("\n Enter the length of base and height of the paallelogram:");
                 scanf("%f%f",,&c,&d);
                 printf("\n Area of parallelogram=%f",c*d);
                 break;
              default:
                printf("\n ERRROR! Invalid Choice!");
                break;
           }
     }          
